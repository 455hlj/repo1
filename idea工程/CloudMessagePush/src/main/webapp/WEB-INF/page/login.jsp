    ...
    <div class="admin-login-background">
        <div class="layui-form login-form">
            <form class="layui-form" action="##" method="post" >
                <!--            <form class="layui-form" action="../../Admin/login">-->
                <div class="layui-form-item logo-title">
                    <h1>信息发送系统登录</h1>
                </div>
                <div class="layui-form-item">
                    <label class="layui-icon layui-icon-username" for="username"></label>
                    <input type="text" name="username" lay-verify="required|account" placeholder="工号" autocomplete="off" class="layui-input" >
                </div>
                <div class="layui-form-item">
...
<script>
    layui.use(['form'], function () {
        ...
        form.on('submit(login)', function (data) {
           ...
           $.post(
               "${pageContext.request.contextPath}/admin/login",data,
               function(result){
                   if(result.success=="1")
                   {
                       layer.msg('登录成功', function () {
                           location.href="${pageContext.request.contextPath}/admin/toForm";
                       });
                   }
                   else{
                       layer.alert('账号或密码错误');
